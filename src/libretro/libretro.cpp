...
bool retro_load_game(const struct retro_game_info *game)
{
   ...
   desc[3].start=0x08000000; desc[3].select=0xFC000000; desc[3].len=romSize; desc[3].ptr=rom;//ROM, parts 1 and 2
      desc[3].flags=RETRO_MEMDESC_CONST;//we need two mappings since its size is not a power of 2
   desc[4].start=0x0C000000; desc[4].select=0xFE000000; desc[4].len=romSize; desc[4].ptr=rom;//ROM part 3
