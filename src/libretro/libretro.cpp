...
bool retro_load_game(const struct retro_game_info *game)
{
   ...
   desc[2].start=0x0E000000; desc[2].select=0xFF000000; desc[2].ptr=flashSaveMemory; desc[2].len=0;//SRAM
   desc[3].start=0x08000000; desc[3].select=0xFC000000; desc[3].ptr=rom;//ROM, parts 1 and 2
      desc[3].len=romSize; desc[3].flags=RETRO_MEMDESC_CONST;//we need two mappings since its size is not a power of 2
   desc[4].start=0x0C000000; desc[4].select=0xFE000000; desc[4].ptr=rom;//ROM part 3
      desc[4].len=romSize; desc[4].flags=RETRO_MEMDESC_CONST;
   desc[5].start=0x00000000; desc[5].select=0xFF000000; desc[5].ptr=bios;//BIOS
      desc[5].len=0x4000; desc[5].flags=RETRO_MEMDESC_CONST;
